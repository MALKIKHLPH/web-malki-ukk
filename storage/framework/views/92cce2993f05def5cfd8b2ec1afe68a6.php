            ...
            <?php $__currentLoopData = $gurus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $guru): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="card-guru">
                    ...
                    <div class="foto-wrapper">
                        <?php if($guru->foto): ?>
                            <img src="<?php echo e(asset('images/' . $guru->foto)); ?>" alt="<?php echo e($guru->nama_guru); ?>">
                        <?php else: ?>
                            <?php echo e(strtoupper(substr($guru->nama_guru, 0, 1))); ?>

                        <?php endif; ?>
                    </div>
                    
                    <div class="nama-guru"><?php echo e($guru->nama_guru); ?></div>
                    <div class="jabatan-guru"><?php echo e($guru->jabatan); ?></div>
                </div>
...
</html><?php /**PATH C:\laragon\www\web-sekolah-ukk-malki\resources\views/guru.blade.php ENDPATH**/ ?>